## This is a fork from MyIGBot, below is the the original readme with an extra

Posting hourly pet stories on Instagram, after reshaping the image. Also added a function for following accounts and liking pictures that post hashtags about cats and dogs.
...
### About this fork
The only difference from the original is the addition of "botgram.py" and "doglufi.py", files consisting in the scripts for posting cat/dog stories and liking/following other cats/dogs.
