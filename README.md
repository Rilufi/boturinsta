...
Posting hourly cat stories on Instagram, after reshaping the image. Also added a function for following accounts and liking pictures that post hashtags about cats.
...
### About this fork
The only difference from the original is the addition of "botgram.py", a file consisting in the script for posting cat stories and liking/following other cats.
